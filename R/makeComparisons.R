...
#' @param pairVector a logical variable indicating whether to treat the two variances as being equal. If TRUE then the pooled variance is used to estimate the variance otherwise the Welch approximation is used.
...
#' @import limma
#' @export 
#' @return qusage array object of set analysis
